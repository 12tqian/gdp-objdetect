...
def coco_small_train_function():
    ...
    return load_coco_json(
        json_file=f"/mnt/tcqian/danielxu/gdp-objdetect/datasets/coco/annotations/instances_train2017_1000small.json",
...
def coco_small_val_function():
    ...
    return load_coco_json(
        json_file=f"/mnt/tcqian/danielxu/gdp-objdetect/datasets/coco/annotations/instances_val2017_small.json",
        image_root=f"/mnt/tcqian/danielxu/gdp-objdetect/datasets/coco/val2017",
        dataset_name=f"coco_2017_val_small",
    )
...
MetadataCatalog.get("coco_2017_val_small").thing_classes = MetadataCatalog.get(
    "coco_2017_val"
).thing_classes
# MetadataCatalog.get(
#     "coco_2017_val_small"
